...
forraskonyvtar='/Applications/World of Warcraft/_retail_/Interface/AddOns/QuestLogger'
celkonyvtar='/Applications/World of Warcraft/_classic_era_/Interface/AddOns'
